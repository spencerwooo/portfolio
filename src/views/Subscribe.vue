<template>
  <div class="container">
    ...
    <div class="article">
      ...
      <p>
        事实上，我除了在少数派更新文章、并用 Netlify
        部署博客，还会在其他平台比如 Twitter
        以及微博更新「碎碎念」，甚至还有可能在 Instagram
        上发布照片等等。因此如果同学希望能够直接订阅我的全部发布，我推荐使用优秀的订阅抓取与管理
        App ——「快知」。
      </p>
      <p>
        直接点击下方链接，就可以进入「快知 -
        SpencerWoo」的主题订阅地址，下载「快知
        App」即可订阅我的全部平台内容的更新。<strong
          >欢迎大家使用我的邀请码：F2Z5L</strong
        >
      </p>
      <AppCard
        msg="快知"
      ...
      <h2>如何只订阅我的少数派文章？</h2>
      <p>
        我的主要输出战场是少数派，因此如果希望只订阅我的少数派文章，可以通过 RSS
        进行订阅管理。
      </p>
      <p>
        RSS 是一个非常简单且方便管理的信息聚合管理协议，是一种
        <a href="https://zh.wikipedia.org/wiki/RSS">消息来源格式规范</a
        >，用以聚合经常发布更新数据的网站，例如博客文章、新闻、音频或视频的网摘。利用
        RSS 同学们可以非常方便的订阅我的文章更新。借助于
        RSSHub，我为我自己的文章生成了一个 RSS
        订阅链接，点击下方链接并复制进入你的 RSS
        阅读器即可实时获得我的文章更新。
      </p>
      <AppCard
        msg="RSS 订阅"
      ...
      <p>
        另外，第一次接触 RSS
        的同学如果感觉陌生，也可以先阅读这两篇文章，它们分别介绍了 RSS
        具体怎么用，以及如何具体利用 RSS 订阅我的文章：
      </p>
      <ul>
        <li>
          <a href="https://diygod.me/ohmyrss/"
            >DIYgod - 我有特别的 RSS 使用技巧</a
          >
        </li>
        <li>
          <a
      ...
      <h2>如何只订阅我的博客？</h2>
      <p>
        我的博客目前使用 Gridsome 搭建与编译，部署于 Netlify
        上面。同样，我提供了 RSS
